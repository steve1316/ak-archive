...
/** The features the runtime can draw now: stage 2's set (meshes, draw order, two-color tint and every blend mode) plus IK constraints. */
export const SUPPORTED: ReadonlySet<Feature> = new Set<Feature>([...(STAGE_FEATURES.get(2) ?? []), "ik"]);
